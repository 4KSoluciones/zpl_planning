CLASS zpl_var_for_f01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zpl_var_for_f01 IMPLEMENTATION.
...
*1) Calcula venta Forecast para Sociedades <> 20000
          IF lt_claves[] IS NOT INITIAL.
            lo_utiles->get_vta_forecast(
              EXPORTING
                i_claves = lt_claves
                i_version = ZPL_UTILES=>c_version_fore
              IMPORTING
                e_result = lt_result
            ).
...
*1) Calcula venta Forecast para Sociedad 20000
