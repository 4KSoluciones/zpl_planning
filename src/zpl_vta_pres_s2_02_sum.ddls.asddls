@AbapCatalog.sqlViewName: 'ZPL_VTAP_22S'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'PL: Venta Presup Soc 2000 - Suc, Canal, Linea'
define view ZPL_VTA_PRES_S2_02_SUM with parameters i_datum : abap.dats
