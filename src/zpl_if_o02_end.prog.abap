...
*1) Selecciona los Reales para calcular coeficiente de Participacion del Gasto sobre la Venta
    SELECT
        a~comp_code,
        a~fiscper,
        a~linea,
...
*2) Selecciona la venta (Real o Presupuesto) para calcular el Gasto Presupuestado
    SELECT
      a~comp_code,
      a~fiscper,
      a~linea,
...
**** COMIENZA PROCESO:
    LOOP AT  result_package ASSIGNING <result_fields>.
      ...
      DO 12 TIMES.
        ...
        ADD 1 TO i.
        CLEAR:  l_fiscper, wa_result, l_coef.
...
******** REALES:
        ...
        IF sy-subrc EQ 0 AND <fs_data>-ventastotal <> 0.

          wa_result-/bic/zpl_venta = <fs_data>-ventastotal.
          wa_result-/bic/zpl_coef =  abs( wa_result-/bic/zpl_gasto / <fs_data>-ventastotal ).
...
******** PRESUPUESTO:  DEBERIA SER FISCYEAR + 1 (2024) PERO PARA PRUEBAS SE MANTIENE EL 2023
          ...
          IF sy-subrc EQ 0.
            ...
            wa_result-/bic/zpl_gastp =  abs(  wa_result-/bic/zpl_coef *  <fs_data_pres>-ventastotal ).
          ELSE.
