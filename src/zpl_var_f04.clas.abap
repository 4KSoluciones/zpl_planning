...
CLASS zpl_var_f04 IMPLEMENTATION.
  ...
  METHOD if_rsplfa_srvtype_imp_exec~execute.
    ...
    TRY.
        ...
        ELSE.
          ...
          FIELD-SYMBOLS <wa_a031> TYPE any.
          FIELD-SYMBOLS <lt_a031> TYPE ANY TABLE.

          DATA lr_data TYPE REF TO data.

          " Create a dynamic work area based on the repository structure
          CREATE DATA lr_data TYPE TABLE OF (l_repositorio).
          ASSIGN lr_data->* TO <lt_a031>.

          SELECT * INTO TABLE @<lt_a031>
            FROM (l_repositorio)
          ...
          IF sy-subrc = 0.
            LOOP AT <lt_a031> ASSIGNING <wa_a031>.

              CREATE DATA lr_struc LIKE LINE OF c_th_data.
              ASSIGN lr_struc->* TO <s>.

              LOOP AT lo_utiles->gt_fields_abm INTO DATA(wa_field).
...
*                  <f> = l_fiscyear.
                  ...
                  WHEN OTHERS.
                    ASSIGN COMPONENT wa_field-in OF STRUCTURE <wa_a031> TO <o>.
                    IF <o> IS ASSIGNED.
                      <f> = <o>.
                      UNASSIGN: <f>, <o>.
                    ENDIF.
          ...
          IF wa_clave IS NOT INITIAL.
            ...
            DO 12 TIMES.
              ...
              LOOP AT lo_utiles->gt_fields_abm INTO wa_field.
                ASSIGN COMPONENT wa_field-out OF STRUCTURE <s> TO <f>.
                IF <f> IS NOT ASSIGNED.
                  CONTINUE.
                ENDIF.
