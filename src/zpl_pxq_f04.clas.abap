...
CLASS zpl_pxq_f04 IMPLEMENTATION.
            ...
            LOOP AT lo_utiles->gt_fields_pxq INTO DATA(wa_field).
              ...
              IF <f> IS ASSIGNED.
                CASE wa_field-in.
                  ...
                  WHEN 'ZTABLA'.
                     <f> = zpl_utiles=>c_plan."R/3 (esta mal), se corrije al pasar a version Final
...
*          READ TABLE c_th_data FROM <s> ASSIGNING FIELD-SYMBOL(<j>).
*          IF sy-subrc EQ 0.
*            <j> = <s>.
*          ELSE.
            "           Nuevo registro o cambio de responsable
