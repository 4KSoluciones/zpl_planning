@AbapCatalog.sqlViewName: 'ZPL_VTAR_23S'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'PL: Venta Real Soc 2000 - Suc, Canal'
define view ZPL_VTA_REAL_S2_03_SUM with parameters i_datum : abap.dats
