@AbapCatalog.sqlViewName: 'ZPL_VTAR_21S'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'PL: Venta Real Soc 2000 - Clave Full - Agregado'
define view ZPL_VTA_REAL_S2_01_SUM with parameters i_datum : abap.dats
