...
CLASS zpl_varq_f02 IMPLEMENTATION.
...
*2) Calcula venta Presupuestada para Sociedad 20000
          IF lt_claves_2000[] IS NOT INITIAL.
            ...
            LOOP AT lt_result ASSIGNING <r>.
              ...
              LOOP AT lo_utiles->gt_fields_varq INTO wa_field.
                ASSIGN COMPONENT wa_field-in OF STRUCTURE <s> TO <f>.
                IF <f> IS ASSIGNED.
                  CASE wa_field-in.
                    WHEN '0INFOPROV'.
