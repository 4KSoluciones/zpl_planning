...
CLASS zpl_varq_f01 IMPLEMENTATION.
  ...
  METHOD if_rsplfa_srvtype_imp_exec_ref~execute.
    ...
    DATA: lr_struc        TYPE REF TO data,
          ...
          wa_result       TYPE zpl_utiles=>ty_wa_result_varq,
          lt_result       TYPE zpl_utiles=>ty_lt_result_varq,
          l_status        TYPE n LENGTH 1,
          l_sociedad      TYPE /bi0/oicomp_code.
    ...
    TRY.
        ...
        IF i_th_ref_data[] IS INITIAL.
          MESSAGE w002(zpl) INTO DATA(l_dummy).
          i_r_msg->add_msg( ).
...
*            DELETE  lt_result WHERE username IS INITIAL.
            ...
            LOOP AT lt_result ASSIGNING <r>.
              ...
              LOOP AT lo_utiles->gt_fields_varq INTO DATA(wa_field).
...
*
    ...
    DELETE e_t_ref_charsel WHERE iobjnm = '0SALES_OFF'.
*
