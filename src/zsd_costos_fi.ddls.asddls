@AbapCatalog.sqlViewName: 'ZSD_COSTOS_FI'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@Analytics:{ dataCategory:#CUBE , dataExtraction.enabled: true }
@EndUserText.label: 'Costos de Materiales para facturas SD'
define view ZSD_COSTOS_FI_VIEW as select from /bic/azsd_o0300 as a 
inner join ZFSD_MOV_FIGL_CONFIG as b
...
} group by   a.bill_num , a.bill_item,  a.material, a.doc_number,  b.ac_doc_typ
--, b.doc_num
